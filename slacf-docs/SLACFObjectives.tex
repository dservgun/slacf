...
\begin{frame} {Objectives}
    \begin{itemize}
      \item Setup a pilot project to evaluate the effectiveness of AgroRemed\textregistered for addressing the contamination in Lago Agrio; 
      \item Setup and operationalize a local team to support the bio-remediation of contaminated land;
      \item Setup a partnership agreement with Sarva Bio Remed to supply AgroRemed\textregistered;
      \item Setup a cleanup protocol for each location;
